...
JavaScriptVPAID.prototype.load = function load(mediaFiles, parameters, options) {
    ...
    return new LiePromise(function loadCreative(resolve, reject) {
        ...
        script.onload = function onload() {
            ...
            // vpaid.once('AdStopped', function () {
            //   console.log('AAAAAAAAAAAAA')
            // });

          console.log(vpaid.onAdVideoFirstQuartile)

          self.once('AdStopped', function () {
            console.log('AAAAAAAAAAAAA2')
          });

          // vpaid.once('AdVideoFirstQuartile', function () {
          //           //   console.log('AAAAAAAAAAAAA3')
          //           // });

          self.once('AdVideoFirstQuartile', function () {
            console.log('AAAAAAAAAAAAA4')
          });
