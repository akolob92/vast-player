...
HTMLVideo.prototype.load = function load(mediaFiles, parameters, options) {
	var self = this;
	...
	return new LiePromise(function loadCreative(resolve, reject) {
		...
		if (typeof options.cleanCallback === 'function') {
			self.__private__.cleanCallback = options.cleanCallback;
		}
...
HTMLVideo.prototype.stopAd = method(function stopAd() {
	...
	if (typeof self.__private__.cleanCallback === 'function') {
		try {
			self.__private__.cleanCallback();
		} catch (err) {
