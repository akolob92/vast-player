...
function loadPlayer(vast, opts) {
    ...
    return player.load(mediaFiles, parameters, opts).then(function setupPixels() {
...
VASTPlayer.prototype.loadXml = function load(xml, opts) {
    ...
    return LiePromise.resolve(new VAST(VAST.pojoFromXML(xml)))
	    .then(function (vast) {
	    ...
	    .then(function (vast) { return loadPlayer.call(self, vast, opts); }).then(function setReady() {
        self.__private__.ready = true;
        self.emit('ready');
